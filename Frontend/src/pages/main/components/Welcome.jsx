    ...
    return (
        <div className="flex justify-center">
            <section className="h-[calc(100svh-64px)] w-full py-16">
                <div className="pb-8">
                    <div className="pb-24">
                        <p className="pl-[0.125rem] font-bold">Здесь талант встречает возможность!</p>
                        <h1 className="text-4xl pb-3">Freelance — это место идей, где одни её&nbsp;предлагают, а&nbsp;другие&nbsp;реализуют.</h1>
                    </div>
